...
int test_resize(cvi_pre_handle_t pre_handle, IVE_HANDLE ive_handle,
...
int test_mutil_resize(cvi_pre_handle_t pre_handle, IVE_HANDLE ive_handle,
                      VIDEO_FRAME_INFO_S *input_frame) {
  bmcv_resize_image resize_param;
  memset(&resize_param, 0, sizeof(resize_param));
...
int test_normalize(cvi_pre_handle_t pre_handle, IVE_HANDLE ive_handle,
                   VIDEO_FRAME_INFO_S *input_frame) {
  ...
  printf("normalize_input0 %d %d %d\n", input_frame->stVFrame.pu8VirAddr[0][0],
         input_frame->stVFrame.pu8VirAddr[0][1], input_frame->stVFrame.pu8VirAddr[0][2]);
  printf("normalize_input1 %d %d %d\n", input_frame->stVFrame.pu8VirAddr[1][0],
         input_frame->stVFrame.pu8VirAddr[1][1], input_frame->stVFrame.pu8VirAddr[1][2]);
  printf("normalize_input2 %d %d %d\n", input_frame->stVFrame.pu8VirAddr[2][0],
         input_frame->stVFrame.pu8VirAddr[2][1], input_frame->stVFrame.pu8VirAddr[2][2]);
  unmap_video_frame(input_frame);

  mmap_video_frame(out_frame);
  printf("normalize_output0 %d %d %d\n", out_frame->stVFrame.pu8VirAddr[0][0],
         out_frame->stVFrame.pu8VirAddr[0][1], out_frame->stVFrame.pu8VirAddr[0][2]);
  printf("normalize_output1 %d %d %d\n", out_frame->stVFrame.pu8VirAddr[1][0],
         out_frame->stVFrame.pu8VirAddr[1][1], out_frame->stVFrame.pu8VirAddr[1][2]);
  printf("normalize_output2 %d %d %d\n", out_frame->stVFrame.pu8VirAddr[2][0],
         out_frame->stVFrame.pu8VirAddr[2][1], out_frame->stVFrame.pu8VirAddr[2][2]);
...
int main(int argc, char *argv[]) {
  ...
  int ret = MMF_INIT_HELPER2(vpssgrp_width, vpssgrp_height, PIXEL_FORMAT_RGB_888, 3, vpssgrp_width,
