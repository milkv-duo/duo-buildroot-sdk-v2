...
CVI_S32 CVI_TDL_FaceDrawRect(const cvtdl_face_t *meta,
                            VIDEO_FRAME_INFO_S *frame, const bool drawText,
                            cvtdl_service_brush_t brush) {
  return Lib_DrawRect(meta, frame, drawText, brush);
}

CVI_S32 CVI_TDL_FaceDrawRect2(const cvtdl_face_t *meta,
                            VIDEO_FRAME_INFO_S *frame, const bool drawText,
                            cvtdl_service_brush_t *brush) {
  return Lib_DrawRect(meta, frame, drawText, brush);
}

CVI_S32 CVI_TDL_ObjectDrawRect(const cvtdl_object_t *meta,
                            VIDEO_FRAME_INFO_S *frame, const bool drawText,
                            cvtdl_service_brush_t brush) {
  return Lib_DrawRect(meta, frame, drawText, brush);
}

CVI_S32 CVI_TDL_ObjectDrawRect2(const cvtdl_object_t *meta,
                            VIDEO_FRAME_INFO_S *frame, const bool drawText,
                            cvtdl_service_brush_t *brush) {
  return Lib_DrawRect(meta, frame, drawText, brush);
}
