...
class MemoryMap:
    ...
    _no_prefix = [
        ...
        "CONFIG_SPL_TEXT_BASE",  # u-boot-spl's CONFIG_SPL_TEXT_BASE is used without CPP.
        "CONFIG_SPL_SIZE_LIMIT",  # u-boot-spl's CONFIG_SPL_SIZE_LIMIT is used without CPP.
    ]
