...
module_param_named(wifi_mac_cfg, bl_mod_params.wifi_mac_cfg, charp, S_IRUGO);
MODULE_PARM_DESC(wifi_mac_cfg, "wifi_mac_cfg: file path of cal data cfg for power offset and xtal cap");
