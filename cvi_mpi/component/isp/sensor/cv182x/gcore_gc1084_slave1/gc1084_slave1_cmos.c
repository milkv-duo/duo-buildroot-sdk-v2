...
#include "gc1084_slave1_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define GC1084_SLAVE1_ID 1084

/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastGc1084_Slave1[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define GC1084_SLAVE1_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastGc1084_Slave1[dev])
#define GC1084_SLAVE1_SENSOR_SET_CTX(dev, pstCtx)   (g_pastGc1084_Slave1[dev] = pstCtx)
#define GC1084_SLAVE1_SENSOR_RESET_CTX(dev)         (g_pastGc1084_Slave1[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunGc1084_Slave1_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

GC1084_SLAVE1_STATE_S g_astGc1084_Slave1_State[VI_MAX_PIPE_NUM] = { {0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeGc1084_Slave1_MirrorFip[VI_MAX_PIPE_NUM] = {0};

CVI_U16 g_au16Gc1084_Slave1_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16Gc1084_Slave1_L2SMode[VI_MAX_PIPE_NUM] = {0};
...
/*****Gc1084 Lines Range*****/
#define GC1084_SLAVE1_FULL_LINES_MAX  (17119) // 0x3FFF(Max VB) + 720 + 16

/*****Gc1084 Register Address*****/
#define GC1084_SLAVE1_EXP_H_ADDR				0x0d03
#define GC1084_SLAVE1_EXP_L_ADDR				0x0d04

#define GC1084_SLAVE1_AGAIN_M_ADDR				0x00d1
#define GC1084_SLAVE1_AGAIN_L_ADDR				0x00d0
#define GC1084_SLAVE1_AGAIN_REG_0x031D			0x031d
#define GC1084_SLAVE1_AGAIN_H_ADDR				0x0dc1
#define GC1084_SLAVE1_COL_AGAIN_H_ADDR			0x00b8
#define GC1084_SLAVE1_COL_AGAIN_L_ADDR			0x00b9
#define GC1084_SLAVE1_AGAIN_REG_0x0155			0x0155

#define GC1084_SLAVE1_DGAIN_H_ADDR				0x00b1
#define GC1084_SLAVE1_DGAIN_L_ADDR				0x00b2

#define GC1084_SLAVE1_VTS_H_ADDR				0x0d41
#define GC1084_SLAVE1_VTS_L_ADDR				0x0042
#define GC1084_SLAVE1_VB_H_ADDR				0x0d79
#define GC1084_SLAVE1_VB_L_ADDR				0x0d7a

#define GC1084_SLAVE1_FLIP_MIRROR_ADDR1		0x0015
#define GC1084_SLAVE1_FLIP_MIRROR_ADDR2		0x0d15

#define GC1084_SLAVE1_RES_IS_720P(w, h)      ((w) <= 1280 && (h) <= 720)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const GC1084_SLAVE1_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	GC1084_SLAVE1_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_stGc1084_Slave1_mode;

	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = GC1084_SLAVE1_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_stGc1084_Slave1_mode.u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_stGc1084_Slave1_mode.f32MaxFps;
	f32MinFps = g_stGc1084_Slave1_mode.f32MinFps;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		u32VMAX = (u32VMAX > GC1084_SLAVE1_FULL_LINES_MAX) ? GC1084_SLAVE1_FULL_LINES_MAX : u32VMAX;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const GC1084_SLAVE1_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = GC1084_SLAVE1_MODE_1280X720P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_stGc1084_Slave1_mode.u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunGc1084_Slave1_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = gc1084_slave1_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = gc1084_slave1_addr_byte;
			pstI2c_data[i].u32DataByteNum = gc1084_slave1_data_byte;
		}

		pstI2c_data[LINEAR_EXP_H].u32RegAddr = GC1084_SLAVE1_EXP_H_ADDR;
		pstI2c_data[LINEAR_EXP_L].u32RegAddr = GC1084_SLAVE1_EXP_L_ADDR;

		pstI2c_data[LINEAR_AGAIN_M].u32RegAddr = GC1084_SLAVE1_AGAIN_M_ADDR;
		pstI2c_data[LINEAR_AGAIN_L].u32RegAddr = GC1084_SLAVE1_AGAIN_L_ADDR;
		pstI2c_data[LINEAR_AGAIN_REG_0x031D_0x2E].u32RegAddr = GC1084_SLAVE1_AGAIN_REG_0x031D;
		pstI2c_data[LINEAR_AGAIN_H].u32RegAddr = GC1084_SLAVE1_AGAIN_H_ADDR;
		pstI2c_data[LINEAR_AGAIN_REG_0x031D_0x28].u32RegAddr = GC1084_SLAVE1_AGAIN_REG_0x031D;
		pstI2c_data[LINEAR_COL_AGAIN_H].u32RegAddr = GC1084_SLAVE1_COL_AGAIN_H_ADDR;
		pstI2c_data[LINEAR_COL_AGAIN_L].u32RegAddr = GC1084_SLAVE1_COL_AGAIN_L_ADDR;
		pstI2c_data[LINEAR_AGAIN_REG_0x0155].u32RegAddr = GC1084_SLAVE1_AGAIN_REG_0x0155;
		pstI2c_data[LINEAR_DGAIN_H].u32RegAddr = GC1084_SLAVE1_DGAIN_H_ADDR;
		pstI2c_data[LINEAR_DGAIN_L].u32RegAddr = GC1084_SLAVE1_DGAIN_L_ADDR;

		pstI2c_data[LINEAR_VTS_H].u32RegAddr = GC1084_SLAVE1_VTS_H_ADDR;
		pstI2c_data[LINEAR_VTS_L].u32RegAddr = GC1084_SLAVE1_VTS_L_ADDR;
		pstI2c_data[LINEAR_VB_H].u32RegAddr = GC1084_SLAVE1_VB_H_ADDR;
		pstI2c_data[LINEAR_VB_L].u32RegAddr = GC1084_SLAVE1_VB_L_ADDR;

		pstI2c_data[LINEAR_FLIP_MIRROR1].u32RegAddr = GC1084_SLAVE1_FLIP_MIRROR_ADDR1;
		pstI2c_data[LINEAR_FLIP_MIRROR2].u32RegAddr = GC1084_SLAVE1_FLIP_MIRROR_ADDR2;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (GC1084_SLAVE1_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = GC1084_SLAVE1_MODE_1280X720P30;
			else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	printf("=======SLAVE1ViPipe =%d,eSnsMirrorFlip = %d=======\n", ViPipe, eSnsMirrorFlip);

	/* Apply the setting on the fly  */
	if (pstSnsState->bInit == CVI_TRUE && g_aeGc1084_Slave1_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeGc1084_Slave1_MirrorFip[ViPipe] = eSnsMirrorFlip;
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_stGc1084_Slave1_mode.u32VtsDef;
	pstSnsState->au32FL[0] = g_stGc1084_Slave1_mode.u32VtsDef;
	pstSnsState->au32FL[1] = g_stGc1084_Slave1_mode.u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &gc1084_slave1_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_stGc1084_Slave1_mode.stImg.stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_stGc1084_Slave1_mode.stImg.stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE)
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &gc1084_slave1_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = gc1084_slave1_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = gc1084_slave1_exit;
...
static CVI_S32 gc1084_slave1_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunGc1084_Slave1_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	GC1084_SLAVE1_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	GC1084_SLAVE1_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	GC1084_SLAVE1_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = GC1084_SLAVE1_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, GC1084_SLAVE1_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, GC1084_SLAVE1_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, GC1084_SLAVE1_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Gc1084_Slave1_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16Gc1084_Slave1_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsGc1084_Slave1_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = gc1084_slave1_standby,
	.pfnRestart             = gc1084_slave1_restart,
	.pfnWriteReg            = gc1084_slave1_write_register,
	.pfnReadReg             = gc1084_slave1_read_register,
	.pfnSetBusInfo          = gc1084_slave1_set_bus_info,
	.pfnSetInit             = sensor_set_init,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnPatchRxAttr		= sensor_patch_rx_attr,
	.pfnPatchI2cAddr	= CVI_NULL,
	.pfnGetRxAttr		= sensor_rx_attr,
	.pfnSetSensorSlave	= gc1084_slave1_linear_set_slave,
