#ifndef __F53_CMOS_PARAM_H_
#define __F53_CMOS_PARAM_H_
...
static const F53_MODE_S g_astF53_mode[F53_MODE_NUM] = {
	[F53_MODE_1080P30] = {
		.name = "1080p30",
		.astImg[0] = {
			.stSnsSize = {
...
struct combo_dev_attr_s f53_rx_attr = {
