...
#include "sc200ai_1l_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC200AI_1L_ID 35
#define SENSOR_SC200AI_1L_WIDTH 1920
#define SENSOR_SC200AI_1L_HEIGHT 1080
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC200AI_1L[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC200AI_1L_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC200AI_1L[dev])
#define SC200AI_1L_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC200AI_1L[dev] = pstCtx)
#define SC200AI_1L_SENSOR_RESET_CTX(dev)         (g_pastSC200AI_1L[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC200AI_1L_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16SC200AI_1L_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16SC200AI_1L_L2SMode[VI_MAX_PIPE_NUM] = {0};

SC200AI_1L_STATE_S g_astSC200AI_1L_State[VI_MAX_PIPE_NUM] = {{0} };
...
/*****SC200AI Lines Range*****/
#define SC200AI_1L_FULL_LINES_MAX  (0x7FFF)

/*****SC200AI Register Address*****/
#define SC200AI_1L_SHS1_0_ADDR		0x3E00
#define SC200AI_1L_SHS1_1_ADDR		0x3E01
#define SC200AI_1L_SHS1_2_ADDR		0x3E02
#define SC200AI_1L_AGAIN1_ADDR		0x3E08
#define SC200AI_1L_DGAIN1_ADDR		0x3E06
#define SC200AI_1L_AGAIN2_ADDR		0x3E12
#define SC200AI_1L_DGAIN2_ADDR		0x3E10
#define SC200AI_1L_VMAX_ADDR		0x320E
#define SC200AI_1L_TABLE_END		0xFFFF

#define SC200AI_1L_RES_IS_1080P(w, h)      ((w) <= 1920 && (h) <= 1080)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	SC200AI_1L_SENSOR_GET_CTX(ViPipe, pstSnsState);
	...
	pstAeSnsDft->u32FullLinesMax = SC200AI_1L_FULL_LINES_MAX;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astSC200AI_1L_mode[SC200AI_1L_MODE_1080P30].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astSC200AI_1L_mode[SC200AI_1L_MODE_1080P30].f32MinFps;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case SC200AI_1L_MODE_1080P30:
		...
		u32VMAX = (u32VMAX > SC200AI_1L_FULL_LINES_MAX) ? SC200AI_1L_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
//	CVI_U32 u16Mode = g_au16SC200AI_1L_GainMode[ViPipe];
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astSC200AI_1L_State[ViPipe].u32Sexp_MAX * 2)) ?
				(g_astSC200AI_1L_State[ViPipe].u32Sexp_MAX * 2) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC200AI_1L_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	SC200AI_1L_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astSC200AI_1L_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	case WDR_MODE_NONE:
		...
		pstSnsState->u32FLStd = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC200AI_1L_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc200ai_1l_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc200ai_1l_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc200ai_1l_data_byte;
		}

			//Linear Mode Regs
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = SC200AI_1L_SHS1_0_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC200AI_1L_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC200AI_1L_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_0_ADDR].u32RegAddr = SC200AI_1L_AGAIN1_ADDR;
			pstI2c_data[LINEAR_AGAIN_1_ADDR].u32RegAddr = SC200AI_1L_AGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_0_ADDR].u32RegAddr = SC200AI_1L_DGAIN1_ADDR;
			pstI2c_data[LINEAR_DGAIN_1_ADDR].u32RegAddr = SC200AI_1L_DGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr = SC200AI_1L_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr = SC200AI_1L_VMAX_ADDR + 1;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC200AI_1L_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC200AI_1L_MODE_1080P30;
			} else {
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->bSyncInit = CVI_FALSE;
	pstSnsState->u8ImgMode = SC200AI_1L_MODE_1080P30;
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstMode = &g_astSC200AI_1L_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc200ai_1l_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC200AI_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc200ai_1l_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc200ai_1l_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc200ai_1l_exit;
...
static CVI_S32 sc200ai_1l_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC200AI_1L_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC200AI_1L_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	SC200AI_1L_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC200AI_1L_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC200AI_1L_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC200AI_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC200AI_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC200AI_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC200AI_1L_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC200AI_1L_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC200AI_1L_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc200ai_1l_standby,
	.pfnRestart             = sc200ai_1l_restart,
	.pfnMirrorFlip          = sc200ai_1l_mirror_flip,
	.pfnWriteReg            = sc200ai_1l_write_register,
	.pfnReadReg             = sc200ai_1l_read_register,
	.pfnSetBusInfo          = sc200ai_1l_set_bus_info,
