...
void CVI_ISPD2_ConfigMessageHandler(TISPD2HandlerInfo *ptHandlerInfo)
{
	...
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetLblcAttr, "CVI_ISP_SetLblcAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetLblcAttr, "CVI_ISP_GetLblcAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetLblcLutAttr, "CVI_ISP_SetLblcLutAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetLblcLutAttr, "CVI_ISP_GetLblcLutAttr");
	...
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetClutHslAttr, "CVI_ISP_SetClutHslAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetClutHslAttr, "CVI_ISP_GetClutHslAttr");
	...
	// TEAISP
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_BNR_SetAttr, "CVI_TEAISP_BNR_SetAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_BNR_GetAttr, "CVI_TEAISP_BNR_GetAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_BNR_SetNP, "CVI_TEAISP_BNR_SetNoiseProfileAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_BNR_GetNP, "CVI_TEAISP_BNR_GetNoiseProfileAttr");

	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_PQ_SetAttr, "CVI_TEAISP_PQ_SetAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_PQ_GetAttr, "CVI_TEAISP_PQ_GetAttr");
