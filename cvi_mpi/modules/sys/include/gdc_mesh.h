...
void mesh_gen_rotation(SIZE_S in_size, SIZE_S out_size, ROTATION_E rot, CVI_U64 mesh_phy_addr, void *mesh_vir_addr);
CVI_S32 mesh_gen_ldc(SIZE_S in_size, SIZE_S out_size, const LDC_ATTR_S *pstLDCAttr,
		     CVI_U64 mesh_phy_addr, void *mesh_vir_addr, ROTATION_E rot);
